...
class EventSources:
    ...
    def _get_verified_real_events(self):
        ...
        {
        "title": "КИИ-2025 (XXII Национальная конференция по искусственному интеллекту)",
        "date": "2025-10-06",
        "location": "Санкт-Петербург, ИТМО / Онлайн",
        "type": "конференция",
        "audience": 300,  # приблизительно
        "themes": ["🤖 Искусственный интеллект"],
        "speakers": [],
        "description": "Национальная конференция ИИ с международным участием в ИТМО.",
        "registration_info": "Регистрация на сайте конференции",
        "source": "kii_conf",
        "url": "https://rcai2025.raai.org/",  # официальный сайт
        "priority_score": 10
        },
        {
            "title": "Промышленный искусственный интеллект 2025",
            "date": "2025-07-03",
            "location": "Санкт-Петербург, СПбПУ",
            "type": "конференция",
            "audience": 200,
            "themes": ["🤖 Искусственный интеллект", "💼 Бизнес и менеджмент", "🚀 Стартапы и инновации"],
            "speakers": [],
            "description": "Конференция по применению ИИ в промышленности, автоматизация, управление, роботизация.",
            "registration_info": "Регистрация на сайте СПбПУ ПИИ-конференции",
            "source": "industrial_ai",
            "url": "https://indai.spbstu.ru/",  # сайт конференции
            "priority_score": 9
        },
        {
            "title": "XXVIII Международная научная конференция «Интернет и современное общество» (IMS-2025)",
            "date": "2025-06-23",
            "location": "Санкт-Петербург, ИТМО / Онлайн (частично)",
            "type": "конференция",
            "audience": 250,
            "themes": ["🌐 Веб-разработка", "📊 Data Science", "💼 Бизнес и менеджмент", "🤖 Искусственный интеллект"],
            "speakers": [],
            "description": "Научная конференция об интернет-технологиях, цифровом обществе и социальных аспектах ИТ.",
            "registration_info": "Регистрация на сайте IMS-2025",
            "source": "ims_conf",
            "url": "https://ims.itmo.ru/",  # сайт конференции
            "priority_score": 8
        },
        {
            "title": "SCM’2025 — Международная конференция по мягким вычислениям и измерениям",
            "date": "2025-05-28",
            "location": "Санкт-Петербург, СПбГЭТУ «ЛЭТИ»",
            "type": "конференция",
            "audience": 150,
            "themes": ["🤖 Искусственный интеллект", "📊 Data Science"],
            "speakers": [],
            "description": "Темы: мягкие вычисления, нейросети, прогнозирование, измерения с применением ИИ.",
            "registration_info": "Регистрация через организаторов СПбГЭТУ",
            "source": "scm_conf",
            "url": "https://scm.etu.ru/",  # сайт конференции
            "priority_score": 7
        },
        {
            "title": "NeuroNT’25 — VI Международная конференция по нейронным сетям и нейротехнологиям",
            "date": "2025-06-04",
            "location": "Санкт-Петербург, СПбГЭТУ «ЛЭТИ» / Онлайн (частично телемост)",
            "type": "конференция",
            "audience": 200,
            "themes": ["🤖 Искусственный интеллект", "📊 Data Science"],
            "speakers": [],
            "description": "Конференция, посвящённая нейронным сетям и нейротехнологиям — теория и приложения.",
            "registration_info": "Регистрация на сайте NeuronNT",
            "source": "neuront_conf",
            "url": "https://neuront.etu.ru/",  # сайт конференции
            "priority_score": 8
        },
        {
            "title": "ИТМ Петербург 2025 (V Всероссийский конгресс ИТМ)",
            "date": "2025-06-17",
            "location": "Санкт-Петербург, ул. Кораблестроителей, 14",
            "type": "конгресс / конференция",
            "audience": 800,
            "themes": ["☁️ Облачные технологии", "🤖 Искусственный интеллект", "📊 Data Science"],
            "speakers": [],
            "description": "Конгресс по медицинской информационной системе, цифровой трансформации здравоохранения и ИИ в медицине.",
            "registration_info": "Регистрация через сайт ИТМ Петербург",
            "source": "itm_spb",
            "url": "https://itm-spb.ru/",  # сайт конгресса
            "priority_score": 8
        },
        {
            "title": "Информационные технологии для Новой школы (ИТНШ) 2025",
            "date": "2025-03-28",
            "location": "Санкт-Петербург, Политех СПбПУ",
            "type": "конференция",
            "audience": 200,
            "themes": ["🤖 Искусственный интеллект", "📊 Data Science", "🌐 Веб-разработка", "💼 Бизнес и менеджмент"],
            "speakers": [],
            "description": "Конференция, посвящённая применению ИТ и ИИ в образовании, обучению учителей, школьным проектам.",
            "registration_info": "Регистрация на сайте ИТНШ",
            "source": "itns_conf",
            "url": "https://eduevent.spb.ru/itns/",  # сайт конференции
            "priority_score": 7
        },
        {
            "title": "GoCloud 2025",
            "date": "2025-04-10",
            "location": "Онлайн + Москва (но можно считать онлайн)",
            "type": "конференция",
            "audience": 1000,
            "themes": ["☁️ Облачные технологии", "🤖 Искусственный интеллект", "📊 Data Science"],
            "speakers": [],
            "description": "Конференция Cloud.ru о облачных сервисах, инфраструктуре, AI, ML, DevOps.",
            "registration_info": "Регистрация на сайте GoCloud",
            "source": "gocloud_conf",
            "url": "https://cloud.ru/gocloud",  # сайт мероприятия
            "priority_score": 9
        },
        {
            "title": "VK Cloud Conf 2025",
            "date": "2025-06-26",
            "location": "Онлайн / Москва",
            "type": "конференция",
            "audience": 500,
            "themes": ["☁️ Облачные технологии", "🤖 Искусственный интеллект", "🚀 Стартапы и инновации"],
            "speakers": [],
            "description": "Конференция по облачной архитектуре, гибридным облакам, надежности, кейсам бизнесов.",
            "registration_info": "Регистрация на сайте VK Cloud Conf",
            "source": "vk_cloud_conf",
            "url": "https://www.mont.ru/ru-ru/events/8090",  # страница мероприятия
            "priority_score": 8
        },
        {
            "title": "Kaspersky Industrial Cybersecurity Conference 2025",
            "date": "2025-09-23",
            "location": "Онлайн",
            "type": "конференция",
            "audience": 600,
            "themes": ["🔐 Кибербезопасность", "☁️ Облачные технологии", "🚀 Стартапы и инновации"],
            "speakers": [],
            "description": "Конференция от Kaspersky о безопасности промышленных систем и ИТ-инфраструктуры.",
            "registration_info": "Регистрация на сайте ICS Kaspersky",
            "source": "kaspersky_ics",
            "url": "https://ics.kaspersky.ru/conference/",  # сайт конференции
            "priority_score": 9
        },
        {
