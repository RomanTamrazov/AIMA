...
from analysis.criteria_filter import CriteriaFilter

async def main():
    """Основная функция приложения - анализ с веб-поиском"""
    ...
    try:
        # Парсинг мероприятий с LLM-поиском и ВЕБ-ПОИСКОМ
        print("\n📥 Загружаем мероприятия...")
        events = await parser.parse_events(
            use_llm_search=True, 
            use_real_parsing=False,
        ...
        print(f"\n✅ Готово! Найдено {len(filtered_events)} подходящих мероприятий")
